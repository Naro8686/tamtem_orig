        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content no-padding">
                  ...
                  <div class="col-md-4">
                    ...
                    >
                      ...
                      >
                        ...
                        <option value="client_worker">Сотрудник</option>
                      </select>
                      <span
                        v-for
                        class="help-block"
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <router-link
                        :to="{
                          name: 'clients.view',
                          params: { id: item.user.organization_id }
                        }"
                        >{{ item.user.organization.org_name }}</router-link
                      >
                    </div>
                  </div>
                </div>
              ...
              <div
                v-if="this.permissions && this.item && this.item.permissions"
...
export default {
  ...
  methods: {
    ...
    getPermissions() {
      axios.get("/admin/api/permissions/site").then((resp) => {
    ...
    loadItem() {
      axios.get("/admin/api/users/" + this.$route.params.id).then((resp) => {
        ...
        if (
          this.item.user.role == "administrator" ||
          this.item.user.role == "moderator"
        ) {
          this.$router.push({
            name: "users.edit",
