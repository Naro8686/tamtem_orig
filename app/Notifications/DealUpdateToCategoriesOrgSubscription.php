...
class DealUpdateToCategoriesOrgSubscription extends Notification implements ShouldQueue
{
    ...
    public function __construct($userEmail, $userName, $categoryName, $urlToDeal, $dealName, $dqh_specification, $dqh_volume, $unit_for_all, $dqh_type_deal, $dqh_min_party)
    {
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage())
            ...
            ->view('emails.deal_update_categories_subcription', ['user_name' => $this->userName, 'dqh_specification' => $this->dqh_specification, 'dqh_volume_unit_for_all' => $this->dqh_volume . " " .  $this->unit_for_all, 'url_to_deal' =>  $this->urlToDeal, 'dqh_type_deal' =>  $this->dqh_type_deal, 'dqh_min_party' =>  $this->dqh_min_party, 'deal_name' =>  $this->dealName ])
