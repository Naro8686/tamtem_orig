...
class OrganizationItemFormatter extends Formatter
{
    ...
    public static function format($item)
    {
        return collect([
            ...
            'organization' => [
                ...
                'kpp' => $item->org_kpp,
                'name' => $item->org_name,
                'org_manager_post' => $item->org_manager_post,
                'org_okved' => $item->org_okved,
                'org_ogrn' => $item->org_ogrn,
                'org_is_active' => $item->org_is_active,
                'org_registration_date' => $item->org_registration_date,
    ...
    public static function formatMarkers($paginator)
    {
    ...
    public static function formatPaginator($paginator, $mapper = null)
    {
        $count = $paginator->count();
        $hasMore = $paginator->hasMorePages();
